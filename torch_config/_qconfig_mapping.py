...
from torch.ao.quantization.fake_quantize import default_weight_fake_quant, FixedQParamsFakeQuantize
...
from torch.ao.quantization import HistogramObserver, default_per_channel_weight_observer
