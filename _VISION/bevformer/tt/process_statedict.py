...
if __name__ == '__main__':
    ...
    print("Missing Torch keys:", load_result.missing_keys)
    print("Unexpected Torch keys:", load_result.unexpected_keys)
    ...
    print("Missing TTNN keys:", load_result.missing_keys)
    print("Unexpected TTNN keys:", load_result.unexpected_keys)
