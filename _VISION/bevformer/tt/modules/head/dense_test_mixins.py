...
from bevformer.utils import bbox_mapping_back, merge_aug_proposals, multiclass_nms
...
class BBoxTestMixin(object):
    ...
    def simple_test_bboxes(self, feats, img_metas, rescale=False):
        ...
        Args:
            feats (tuple[ttnn.Tensor]): Multi-level features from the
    ...
    def aug_test_bboxes(self, feats, img_metas, rescale=False):
        ...
        merged_factors = ttnn.cat(aug_factors, dim=0) if aug_factors else None
    ...
    def merge_aug_bboxes(self, aug_bboxes, aug_scores, img_metas):
        ...
        bboxes = ttnn.cat(recovered_bboxes, dim=0)
        if aug_scores is None:
            return bboxes
        else:
            scores = ttnn.cat(aug_scores, dim=0)
