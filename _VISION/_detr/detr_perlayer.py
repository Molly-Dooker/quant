...
def main(args):
    ...
    if not EVAL:
        ...
        modules = [
            "model.backbone.conv_encoder.model.encoder.stages.0.layers.0.shortcut.convolution",
            "model.backbone.conv_encoder.model.encoder.stages.0.layers.0.layer.0.convolution",
            "model.backbone.conv_encoder.model.encoder.stages.0.layers.0.layer.1.convolution",
            "model.backbone.conv_encoder.model.encoder.stages.0.layers.0.layer.2.convolution",
            "model.backbone.conv_encoder.model.encoder.stages.0.layers.1.layer.0.convolution",
            "model.backbone.conv_encoder.model.encoder.stages.0.layers.1.layer.1.convolution",
            "model.backbone.conv_encoder.model.encoder.stages.0.layers.1.layer.2.convolution",
            "model.backbone.conv_encoder.model.encoder.stages.0.layers.2.layer.0.convolution",
            "model.backbone.conv_encoder.model.encoder.stages.0.layers.2.layer.1.convolution",
        ...
        start = index*3
        stop  = (index + 1) * 3
        modules_=[m for m in modules[start:stop]]
